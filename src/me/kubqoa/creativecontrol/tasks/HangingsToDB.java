...
/*    */ 
/*    */ public class HangingsToDB
/*    */   extends BukkitRunnable
/*    */ {
/*    */   public void run()
/*    */   {
/* 15 */     if (Main.dbtype) {
/* 16 */       String sql = "INSERT INTO `" + Main.dbprefix + "hangings` (x,y,z,world) VALUES ";
/* 17 */       for (Location location : Main.WhangingsLocation) {
...
/*    */     } else {
/* 24 */       String sql = "INSERT INTO `" + Main.dbprefix + "hangings` (x,y,z,world) ";
/* 25 */       int i = 0;
/* 26 */       for (Location location : Main.WhangingsLocation) {
/* 27 */         if (i == 0) {
...
/*    */     }
/* 37 */     Main.WhangingsLocation.clear();
/*    */   }
/*    */ }


/* Location:              C:\Users\Zack\Downloads\CreativeControl (6).jar!\me\kubqoa\creativecontrol\tasks\HangingsToDB.class
