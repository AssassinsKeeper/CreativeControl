...
/*    */ 
/*    */ public class VehiclesFromDB
/*    */   extends BukkitRunnable
/*    */ {
/*    */   public void run()
/*    */   {
/* 15 */     if (Main.dbtype) {
/* 16 */       String sql = "DELETE FROM `" + Main.dbprefix + "vehicles` WHERE (x,y,z,world) IN (";
/* 17 */       for (Location location : Main.RvehiclesLocation) {
...
/*    */     } else {
/* 24 */       String sql = "DELETE FROM `" + Main.dbprefix + "vehicles` WHERE ";
/* 25 */       for (Location location : Main.RvehiclesLocation) {
...
/*    */     }
/* 31 */     Main.RvehiclesLocation.clear();
/*    */   }
/*    */ }


/* Location:              C:\Users\Zack\Downloads\CreativeControl (6).jar!\me\kubqoa\creativecontrol\tasks\VehiclesFromDB.class
